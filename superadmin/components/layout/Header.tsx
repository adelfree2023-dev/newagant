        ...
        <header className="h-16 bg-white border-b px-6 flex items-center justify-between sticky top-0 z-30">
            ...
            <div className="flex-1 max-w-md">
                <div className="relative">
                    ...
                    <input
                        type="text"
                        placeholder="ابحث في المتاجر، المستخدمين..."
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 pr-4 border-r">
                    <div className="w-9 h-9 bg-dark-900 rounded-full flex items-center justify-center">
                        <Shield className="w-5 h-5 text-primary-500" />
                    </div>
                    <div className="hidden sm:block">
                        <p className="text-sm font-medium text-gray-900">Super Admin</p>
                        <p className="text-xs text-gray-500">admin@coreflex.io</p>
                    </div>
